...
// This should never be used from any global contexts, otherwise you will receive a no-op Logger.
// This is becase the logp package needs to be initialized first
func NewLogger(selector string, options ...LogOption) *Logger {
	return newLogger(loadLogger().rootLogger, selector, options...)
}

// WithOptions returns a clone of logger with options applied.
...
// Fileds added to che child don't affect the parent, and vice versa.
...
// Info uses fmt.Sprint to construt and log a message.
...
// DPanic uses fmt.Sprint to construct and log a message, In development then panics.
...
// DPanicf uses fmt.Sprintf to log a templated message. In development then panics.
func (l *Logger) DPanicf(format string, args ...interface{}) {
	l.sugar.DPanicf(format, args...)
}

// Debugw logs a message with some additional context. The additional context is added in the form of key-value pairs.
// The optimal way to write the value to the log message will be inferred by the value's type.
// To explicityly specify a type you can pass a Field such as logger.Stringer.
func (l *Logger) Debugw(msg string, keysAndValues ...interface{}) {
	l.sugar.Debugw(msg, keysAndValues...)
}

// Infow logs a message with some additional context. The additional context is added in the form of key-value pairs.
// The optimal way to write the value to the log message will be inferred by the value's type.
// To explicityly specify a type you can pass a Field such as logger.Stringer.
...
// Warnw logs a message with some additional context. The additional context is added in the form of key-value pairs.
// The optimal way to write the value to the log message will be inferred by the value's type.
// To explicityly specify a type you can pass a Field such as logger.Stringer.
...
// Errorw logs a message with some additional context. The additional context is added in the form of key-value pairs.
// The optimal way to write the value to the log message will be inferred by the value's type.
// To explicityly specify a type you can pass a Field such as logger.Stringer.
...
// The additional context is added in the form of key-value pairs.
// The optimal way to write the value to the log message will be inferred by the value's type.
// To explicityly specify a type you can pass a Field such as logger.Stringer.
...
// DPanicw logs a message with some additional context. In deveopment then panic.
// The additional context is added in the form of key-value pairs.
// The optimal way to write the value to the log message will be inferred by the value's type.
// To explicityly specify a type you can pass a Field such as logger.Stringer.
